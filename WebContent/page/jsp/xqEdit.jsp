...
<body>
	<div class="page-container">
		<form class="form form-horizontal" id="form-user-pwd"
			action="XqCon/Update.action" method="post">
			<input type="hidden" name="id" id="id" value="${xq.id}" />
			<div class="row cl">
				...
				<div style="float: left;" class="formControls col-5">
					<input required autofocus type="text" class="input-text" 
						name="xqId" id="xqId" value="${xq.xqId}" >
				</div>
				...
				<div style="float: left;" class="formControls col-5">
					<input type="text" class="input-text"
						name="xqName" id="xqNameId" required value="${xq.xqName}">
				</div>
			...
			<div class="row cl">
				...
				<div style="float: left;" class="formControls col-5">
					<input type="text" class="input-text" id="wyNameId"
						name="wyName" required value="${xq.wyName}">
				</div>
			...
			<div class="row cl">
				...
				<div style="float: left;" class="formControls col-5">
					<input type="text" class="input-text" id="wyTelId"
						name="wyTel" required value="${xq.wyTel}">
				</div>
			...
			<div class="row cl">
				...
				<div style="float: left;" class="formControls col-5">
				<textarea id="beiZhuId" class="input-text" name="beiZhu" value="${xq.beiZhu}"></textarea>
				</div>
